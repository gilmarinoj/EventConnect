<main class="agenda">
    ...
    <p class="agenda__descripcion">Workshops y Conferencias dictados por los expertos de EventConnect</p>

    <div class="eventos">
        <h3 class="eventos__heading">&lt;Conferencias /></h3>
        <p class="eventos__fecha">Viernes 7 de Febrero</p>
        ...
        <p class="eventos__fecha">Sabado 8 de Febrero</p>
